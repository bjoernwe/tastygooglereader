...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\tastygooglereader on
     Windows, /home/user/dev/tastygooglereader on Linux) in a file named
     tastygooglereader@bjrn and copy that file to
